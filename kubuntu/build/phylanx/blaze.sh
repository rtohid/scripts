...
BLAZE_DIR=$SRC_PATH/blaze
BUILD_DIR=/home/$USER/build/blaze/$BUILD_TYPE

if [ -z "$INSTALL_DIR" ]; then
  INSTALL_ROOT=/home/$USER/install
  INSTALL_DIR=$INSTALL_ROOT/blaze/$BUILD_TYPE
fi
...
build()
{
  ...
  if [ ! -d $BLAZE_DIR ]; then
    git clone https://bitbucket.org/blaze-lib/blaze.git $BLAZE_DIR
  fi
